...
from GVNEditor.Interface.EditorDialogue.dialogue_branches_entry import BranchesEntry
from GVNEditor.Interface.EditorDialogue.dialogue_branches_edit_prompt import EditBranchPrompt
