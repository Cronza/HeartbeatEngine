...
from GVNEditor.Interface.DetailsPanel.details_panel import DetailsPanel
from GVNEditor.Interface.EditorDialogue.dialogue_branches_panel import BranchesPanel
from GVNEditor.Interface.EditorDialogue.dialogue_sequence_panel import DialogueSequencePanel
